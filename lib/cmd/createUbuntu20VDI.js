...
module.exports.exec = async function(params) {
    ...
    const xforgeArgs = {
        ...
        other: [
            ...
            params[1], params[2], params[3], params[4], params[5], params[6]?`--cdrom /kloudust/catalog/${params[6]}`:"--cdrom https://mirror.pit.teraswitch.com/ubuntu-releases/20.04/ubuntu-20.04.1-desktop-amd64.iso"
        ]
    }
