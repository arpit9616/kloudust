...
module.exports.exec = async function(params) {
    ...
    const xforgeArgs = {
        ...
        other: [
            ...
            params[1], params[2], params[3], params[4], params[5], params[6]?`--cdrom /kloudust/catalog/${params[6]}`:"--cdrom https://mirrors.oit.uci.edu/centos/8.2.2004/isos/x86_64/CentOS-8.2.2004-x86_64-minimal.iso"
        ]
    }
